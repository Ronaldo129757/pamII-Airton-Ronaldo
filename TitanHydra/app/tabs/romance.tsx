...
const MovieScreen = () => {
  ...
  const movies = [
    { id: '121', title: 'Pokêmon: O Filme', image: 'https://play-lh.googleusercontent.com/BEgD7H9DDBp581nxdJ1zCcTmObenUvo3cd7tLGkpx9_NT412i5NS-X_n-8AmpcA9biX2' },
    { id: '122', title: 'O Espanta Tubarões', image: 'https://upload.wikimedia.org/wikipedia/pt/3/30/Shark_Tale.jpg' },
    { id: '123', title: 'Por Água Abaixo', image: 'https://upload.wikimedia.org/wikipedia/pt/a/a0/PorAguaAbaixo.jpg' },
    { id: '124', title: 'Bee Movie', image: 'https://upload.wikimedia.org/wikipedia/pt/f/f9/Bee_movie.jpg' },
    { id: '125', title: 'Bob Esponja: O filme', image: 'https://upload.wikimedia.org/wikipedia/pt/2/2f/6875.jpg' },
    { id: '126', title: 'Monstros S.A', image: 'https://upload.wikimedia.org/wikipedia/pt/7/75/Monsters_Inc.jpg' },
    { id: '127', title: 'Carros', image: 'https://upload.wikimedia.org/wikipedia/pt/9/9b/Carros_p%C3%B4ster.jpg' },
    { id: '128', title: 'Garfield: Fora de Casa', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0F5H6gdg59kKwY0XkPNu3Ipd4-HqjSj77kw&s' },
    { id: '129', title: 'Meu Malvado Favorito 2', image: 'https://upload.wikimedia.org/wikipedia/pt/2/26/Despicable_Me_2.jpg' },
    { id: '130', title: 'Os Caras Malvados 2', image: 'https://tse2.mm.bing.net/th/id/OIF.kUc6I94HAXdWY07RvxQPfQ?rs=1&pid=ImgDetMain&o=7&rm=3' },
    { id: '131', title: 'Gato de Botas 2', image: 'https://www.atoupeira.com.br/wp-content/uploads/2023/01/gato-de-botas-2-poster-nacional-critica.jpg' },
    { id: '132', title: 'Up: Altas Aventuras', image: 'https://upload.wikimedia.org/wikipedia/pt/a/a8/Up_p%C3%B4ster.jpg' },
    { id: '133', title: 'Procurando Nemo', image: 'https://upload.wikimedia.org/wikipedia/pt/2/29/Finding_Nemo.jpg' },
    { id: '134', title: 'Viva: A vida é uma Festa', image: 'https://upload.wikimedia.org/wikipedia/pt/a/ae/Cocofilme.png' },
    { id: '135', title: 'Rango', image: 'https://m.media-amazon.com/images/M/MV5BMTc4NjEyODE1OV5BMl5BanBnXkFtZTcwMjYzNTkxNA@@._V1_.jpg' },
    { id: '136', title: 'Wall-e', image: 'https://play-lh.googleusercontent.com/s90tRLDG8npS1xHbN3Hu7c7yBdLyv05CuLOwIjAR1Lsk8fj-jCiPiMkdbHamxLPQDTBQ' },
    { id: '137', title: 'Os Incriveis', image: 'https://upload.wikimedia.org/wikipedia/pt/4/4b/Os_Incr%C3%ADveis.jpg' },
    { id: '138', title: 'Angry Birds: O filme', image: 'https://upload.wikimedia.org/wikipedia/pt/e/e5/Angry_birds_poster.jpg' },
    { id: '139', title: 'Meu Malvado Favorito 4', image: 'https://br.web.img3.acsta.net/img/6c/71/6c71afa89fd8ed8999b3e04d8d794a0e.jpg' },
    { id: '140', title: 'Ratatouille', image: 'https://www.papodecinema.com.br/wp-content/uploads/2012/08/20181221-medium-ratatouille-poster-size-12-inch-x-18-inch-pack-of-1-original-imafy8d2aqshpguj.webp' },
  ];
